...
public class LOGIN_Page extends JFrame implements ActionListener {
	...
	public LOGIN_Page(ReserveBank rb) {
       ...
       ok = new JButton("Confirm"); ok.setBackground(Color.red); ok.setForeground(Color.white); ok.setFont(new Font("Helvetica", Font.PLAIN, 15)); ok.setBounds(350, 250, 100, 30);
	...
	public void actionPerformed(ActionEvent ae) {
		if(ae.getSource() == ok) {rb.authentic(this, rb);}
