...
public class CREATE_Page extends JFrame implements ActionListener {
	...
	public JLabel l_fnm, l_lnm, gender, age, addrss, info, l_pno, l_terms, l_terms2, l_cnt, jl_user, jl_pass;
	...
	public CREATE_Page(ReserveBank rb) {
       ...
       cb_terms = new JCheckBox(); cb_terms.setBounds(250, 552, 20, 20); cb_terms.setBackground(Color.black);
       ...
       cnf = new JButton("Confirm");  cnf.setFont(new Font("Helvetica", Font.BOLD, 15)); cnf.setBounds(280, 602, 100, 30); cnf.setBackground(Color.red); cnf.setForeground(Color.white); 
       cnf.setEnabled(true);
	...
	public void actionPerformed(ActionEvent ae) {
		if(ae.getSource() == cnf) {rb.createAccount(rb, this);} 
