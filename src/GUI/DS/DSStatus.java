...
public class DSStatus extends JFrame implements ActionListener {
	...
	public DSStatus(WhenSQLExceptionOccurs sq) {
	    ...
	    c.add(jl_fnm); c.add(jl_gender); c.add(jl_age); c.add(jl_addrss); c.add(jl_pno); c.add(jl_cnt); c.add(jl_gfnm); c.add(jl_ggender); c.add(jl_gage); c.add(ta_addrss); c.add(jl_gpno); c.add(jl_gcnt); c.add(jl_user); c.add(jl_wel);
